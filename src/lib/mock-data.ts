...
export const MOCK_ENGAGEMENTS: Engagement[] = [
  ...
  // inquiry — came in this morning, no response yet
  {
    ...
    engagement_flags: [], post_event_flags: [], post_event_needed: [], post_event_not_needed: [],
  ...
  // TODAY — happening today April 3, fully ready
  {
    ...
    contract_required: true, contract_sent_at: '2026-02-16T10:00:00Z', contract_signed_at: '2026-02-19T09:00:00Z',
    outgoing_materials: [
      { id: 'bio', label: 'Bio', done: true, added_at: '2026-02-20T09:00:00Z', sent_at: '2026-03-01T10:00:00Z' },
      { id: 'headshot', label: 'Headshot', done: true, added_at: '2026-02-20T09:00:00Z', sent_at: '2026-03-01T10:00:00Z' },
      { id: 'book_info', label: 'Book Info & Order Link', done: true, added_at: '2026-02-20T09:00:00Z', sent_at: '2026-03-01T10:00:00Z' },
      { id: 'speaker_intro', label: 'Speaker Intro', done: true, added_at: '2026-02-20T09:00:00Z', sent_at: '2026-03-01T10:00:00Z' },
    ],
    incoming_materials: [
      { id: 'in1', label: 'Agenda / Run of Show', received: true, added_at: '2026-03-01T09:00:00Z', received_at: '2026-03-23T10:00:00Z', note: 'Mori on at 10am sharp. AV check 8:30am with Chris.' },
      { id: 'in2', label: 'Attendee List', received: true, added_at: '2026-03-01T09:00:00Z', received_at: '2026-03-23T10:00:00Z', note: 'Final headcount 247.' },
    ],
    briefing_complete: true, briefing_complete_at: '2026-03-23T10:00:00Z',
  ...
  // contract_sent — legal holding it up
  {
    ...
    contract_required: true, contract_sent_at: '2026-03-21T10:00:00Z',
    outgoing_materials: [
      { id: 'bio', label: 'Bio', done: true, added_at: '2026-03-21T09:00:00Z', sent_at: '2026-03-21T10:00:00Z' },
      { id: 'headshot', label: 'Headshot', done: true, added_at: '2026-03-21T09:00:00Z', sent_at: '2026-03-21T10:00:00Z' },
    ],
    incoming_materials: [],
  ...
  // contract_signed — briefing doc still needed
  {
    ...
    contract_required: true, contract_sent_at: '2026-03-02T10:00:00Z', contract_signed_at: '2026-03-26T14:00:00Z',
    outgoing_materials: [
      { id: 'bio', label: 'Bio', done: false, added_at: '2026-04-01T10:00:00Z' },
      { id: 'headshot', label: 'Headshot', done: false, added_at: '2026-04-01T10:00:00Z' },
      { id: 'speaker_intro', label: 'Speaker Intro', done: false, added_at: '2026-04-01T10:00:00Z' },
    ],
    incoming_materials: [
      { id: 'in1', label: 'Run of Show', received: false, added_at: '2026-04-01T10:00:00Z' },
    ],
    briefing_complete: false,
    post_event_flags: [], post_event_needed: [], post_event_not_needed: [],
  ...
  // client_deliverables_sent — event in 19 days
  {
    ...
    contract_required: true, contract_sent_at: '2026-01-25T09:00:00Z', contract_signed_at: '2026-01-28T10:00:00Z',
    outgoing_materials: [
      { id: 'bio', label: 'Bio', done: true, added_at: '2026-01-29T09:00:00Z', sent_at: '2026-02-01T10:00:00Z' },
      { id: 'headshot', label: 'Headshot', done: true, added_at: '2026-01-29T09:00:00Z', sent_at: '2026-02-01T10:00:00Z' },
      { id: 'speaker_intro', label: 'Speaker Intro', done: true, added_at: '2026-01-29T09:00:00Z', sent_at: '2026-02-01T10:00:00Z' },
    ],
    incoming_materials: [
      { id: 'in1', label: 'Run of Show', received: true, added_at: '2026-03-01T09:00:00Z', received_at: '2026-03-29T11:00:00Z', note: 'Mori on at 10:15am following opening remarks.' },
      { id: 'in2', label: 'Attendee List', received: true, added_at: '2026-03-01T09:00:00Z', received_at: '2026-03-29T11:00:00Z', note: 'Final headcount 182.' },
    ],
    briefing_complete: true, briefing_complete_at: '2026-03-15T10:00:00Z',
    post_event_flags: [], post_event_needed: [], post_event_not_needed: [],
  ...
  // invoice overdue — client says it's processing
  {
    ...
    section: 'wrap-up',
    engagement_flags: ['contract_sent', 'contract_signed', 'client_deliverables_sent', 'advance_sheet_complete'],
    post_event_flags: ['invoice', 'thank_you'], post_event_needed: ['testimonial', 'follow_up'], post_event_not_needed: ['media'],
    invoice_sent_at: '2026-03-01',
  ...
  // invoice paid, media received, pending final close-out
  {
    ...
    section: 'wrap-up',
    engagement_flags: ['contract_sent', 'contract_signed', 'client_deliverables_sent', 'advance_sheet_complete'],
    post_event_flags: ['invoice', 'thank_you', 'testimonial', 'media', 'social_media', 'follow_up'], post_event_needed: [], post_event_not_needed: [],
    invoice_sent_at: '2026-03-14',
  ...
  // interview — published, complete
  {
    ...
    post_event_flags: ['media', 'thank_you'], post_event_needed: ['invoice'], post_event_not_needed: ['social_media'],
    organization: 'Forbes',
