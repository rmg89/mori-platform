...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = `You are drafting a professional email reply on behalf of Mori Taheripour's team (admin@moritaheripour.com). Mori is a Wharton professor, bestselling author, and keynote speaker specializing in negotiation.
